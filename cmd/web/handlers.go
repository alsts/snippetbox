...
import (
	...
	"snippetbox.alsts.net/internal/validator"
)
...
type snippetCreateForm struct {
	Title               string     `form:"title"` // struct tags!
	Content             string     `form:"content"`
	Expires             int        `form:"expires"`
	validator.Validator `form:"-"` // Embedding Validator type -> Passing other struct props and methods!
}
